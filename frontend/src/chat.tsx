  ...
  return (
    <div className="max-h-screen flex-col items-center bg-cover bg-[url('dashboard-bg8.svg')] bg-centre justify-center mx-auto items-start justify-start">
      ...
      <div className="flex max-w-[60vw] overflow-x-auto">
        <h3 className="text-black text-[20px] pb-4 font-semibold px-4 mx-3 outline outline-3 outline-solid outline-[#86AD95] rounded-lg">
          Home
        </h3>
        {openPresentations.map((presentation) => (
          <h3
            className={`text-black text-[24px] pb-4 font-semibold px-4 mx-3 ${
              focusedPresentation === presentation ? "bg-black" : "bg-[#F6F2ED]"
              ...
              <div
                ...
                onClick={() => {
                  if (!openPresentations.includes(presentation)) {
                    setOpenPresentations([presentation, ...openPresentations]);
                  }
